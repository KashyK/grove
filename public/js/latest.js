...
},{"./json/base":9,"./json/mats":10,"./json/weapons":11,"rpg-tools/lib/ProtoTree":18}],9:[function(require,module,exports){
module.exports={
    "@item": {
        name: "-- Item --",
...
},{"./globals":2,"./gui":3,"./items":8,"./multiplayer":14,"./player":15,"./shooting":16,"lodash":17}],14:[function(require,module,exports){
"use strict";
            ...
            window.addEventListener('mousedown', function () {
                if (weapon) {
                    ...
                    var tween = new TWEEN.Tween(weapon.rotation).to({
                        x: [-Math.PI / 2, 0]
                    }, 1 / player.equipped.weapon.spd * 3000).onStart(function () {
